...
createErrorFromNameLookup.set(
  ...
  () => new InvalidEscrowConstraintError()
)
...
createErrorFromNameLookup.set(
  ...
  () => new InvalidUpdateAuthorityError()
)
...
createErrorFromNameLookup.set(
  ...
  () => new ConstraintAlreadyExistsError()
)
...
createErrorFromNameLookup.set(
  ...
  () => new FailedToFindTokenAmountError()
)
...
createErrorFromNameLookup.set(
  ...
  () => new TransferEffectConflictError()
)
...
createErrorFromNameLookup.set(
  ...
  () => new FreezeAuthorityNotSetError()
)
...
createErrorFromNameLookup.set(
  ...
  () => new CannotBurnPrintEditionError()
)
...
createErrorFromNameLookup.set(
  ...
  () => new ConstraintKeyNotFoundError()
)
